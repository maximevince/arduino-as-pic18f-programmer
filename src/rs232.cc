...
char comports[22][13]={"/dev/ttyACM0","/dev/ttyACM1","/dev/ACM2","/dev/ttyACM0","/dev/ttyACM1","/dev/ACM2",
						"/dev/ttyACM0","/dev/ttyACM1","/dev/ACM2","/dev/ttyS10","/dev/ttyS11",
...
static void cprintf(int comport_number, const char *text)  /* sends a string to serial port */
{
